        ...
        <div className="bg-gray-300 w-full p-4 col-span-3 text-center">
            ...
            <div className="my-4">
                ...
                <div className="h-40 bg-white grid grid-cols-12 place-items-center text-blue-500">
                    <i className="fa-brands fa-facebook fa-2xl col-span-4"></i>
                    <i className="fa-brands fa-twitter fa-2xl col-span-4"></i>
                    <i className="fa-brands fa-youtube fa-2xl col-span-4"></i>
                </div>
            </div>
