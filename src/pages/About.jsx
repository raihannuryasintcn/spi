    ...
    <div className="grid grid-cols-12 w-full h-auto">
      <div className="bg-gray-100 w-full p-4 col-span-9">
        ...
        <p className="text-gray-600">
          Taat dan patuh pada nilai-nilai yang menjadi tanggung jawab
          perusahaan.
        </p>
        ...
        <p className="text-gray-600">
          Konsisten dalam melayani pelanggan dengan sebaik-baiknya dan menjaga
          jati diri sebagai pekerja mesin pendingin.
        </p>
        ...
        <p className="text-gray-600">
          Berkomunikasi dengan ramah, sopan santun, dan bahasa yang baik dan
          beretika.
        </p>
        ...
        <p className="text-gray-600 pb-12">
          Berkomitmen pada pendidikan berkelanjutan dan pembelajaran hal-hal
          baru.
        </p>
